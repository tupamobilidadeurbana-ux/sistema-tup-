    ...
    <div className="min-h-screen flex items-center justify-center bg-[#000814] p-6 text-white font-['Inter'] relative overflow-hidden">
      ...
      <div className="max-w-4xl w-full relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-blue-200/30 text-[10px] font-bold uppercase tracking-[0.6em]">Escolha o seu ponto de acesso</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-blue-200/40 text-[11px] font-bold uppercase tracking-[0.2em] mb-10">Administração & Leads</p>
